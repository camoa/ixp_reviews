...
use Drupal\config_overlay\Exception\UnsupportedMethodCallException;
...
class ReadOnlyUnionStorage implements StorageInterface {
  ...
  public function write($name, array $data) {
    throw new UnsupportedMethodCallException(__METHOD__ . ' is not allowed on a ' . static::class);
  }
  ...
  public function encode($data) {
    ...
    if (!$storage) {
      throw new UnsupportedMethodCallException(__METHOD__ . ' is not allowed on an empty ' . static::class);
    }
