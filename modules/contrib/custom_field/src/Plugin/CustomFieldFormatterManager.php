...
class CustomFieldFormatterManager extends DefaultPluginManager implements CustomFieldFormatterManagerInterface {
  ...
  public function createInstance($plugin_id, array $configuration = []) {
    ...
    return new $plugin_class($plugin_id, $plugin_definition, $configuration['custom_field'], $configuration['settings'], $configuration['label'], $configuration['view_mode'], $configuration['third_party_settings']);
  }
  ...
  public function getInstance(array $options) {
    ...
    /** @var \Drupal\custom_field\Plugin\CustomFieldTypeInterface $custom_field */
    $custom_field = $options['custom_field'];
    $field_type = $custom_field->getDataType();
